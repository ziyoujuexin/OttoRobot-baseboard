...
void ActionManager::register_default_actions() {
    ...
    silly.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_EAR_SWING)] = 30;
    silly.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_SWING)] = 30;
    silly.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = 40;
    silly.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = -40;
    silly.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -15;
    silly.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 15;
    silly.params.phase_diff[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = PI;
   ...
   RegisteredAction funny = {};
    ...
    funny.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -50;
    funny.params.offset[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = -30;
    funny.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_LEG_ROTATE)] = 15;
    funny.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_EAR_SWING)] = 20;
    funny.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_SWING)] = 20;
 ...
 RegisteredAction happy = {};
    ...
    happy.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -10;
    happy.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 10;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = 15;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 15;
    happy.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = PI;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::HEAD_PAN)] = 25;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = 10;
    happy.params.phase_diff[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = PI / 2;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_EAR_SWING)] = 30;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_SWING)] = 30;
    happy.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ARM_LIFT)] = -45;
    happy.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_LIFT)] = -45;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ARM_SWING)] = 40;
    happy.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_SWING)] = 40;
    happy.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_SWING)] = PI;
    ...
    sad.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -10;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 10;
    sad.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = 15;
    sad.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 15;
    sad.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = PI;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = 30;
    sad.params.amplitude[static_cast<uint8_t>(ServoChannel::HEAD_PAN)] = 10;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_EAR_LIFT)] = 20;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_LIFT)] = 20;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ARM_LIFT)] = -50;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_LIFT)] = -50;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ARM_SWING)] = 30;
    sad.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_SWING)] = -30;
    sad.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ARM_LIFT)] = 5;
    sad.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_LIFT)] = 5;
    sad.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_LIFT)] = 0;
    ...
    laughing.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -10;
    laughing.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 10;
    laughing.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_LEG_ROTATE)] = 15;
    laughing.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_LEG_ROTATE)] = 15;
    laughing.params.offset[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = -25;
    laughing.params.amplitude[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = 10;
    laughing.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_EAR_SWING)] = 40;
    laughing.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_SWING)] = -40;
    ...
    angry.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -10;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 10;
    angry.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = 20;
    angry.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 20;
    angry.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = PI;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_LEG_ROTATE)] = 20;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_LEG_ROTATE)] = 20;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = 20;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_EAR_SWING)] = -30;
    angry.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_EAR_SWING)] = 30;
    ...
    crying.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ANKLE_LIFT)] = -10;
    crying.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ANKLE_LIFT)] = 10;
    crying.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_LEG_ROTATE)] = 8;
    crying.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_LEG_ROTATE)] = 8;
    crying.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_LEG_ROTATE)] = PI;
    crying.params.offset[static_cast<uint8_t>(ServoChannel::HEAD_TILT)] = 40;
    crying.params.offset[static_cast<uint8_t>(ServoChannel::LEFT_ARM_LIFT)] = -60;
    crying.params.offset[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_LIFT)] = -60;
    crying.params.amplitude[static_cast<uint8_t>(ServoChannel::LEFT_ARM_SWING)] = 20;
    crying.params.amplitude[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_SWING)] = 20;
    crying.params.phase_diff[static_cast<uint8_t>(ServoChannel::RIGHT_ARM_SWING)] = PI;
